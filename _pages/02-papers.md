...
<img style="float: left; width: 25%; padding-right: 20px; padding-bottom:40px;" src="{{ paper.image | prepend: '/assets/img/' | prepend: site.baseurl | prepend: site.url }}" alt="{% if paper.imagealt %}{{paper.imagealt}}{% endif %}" title="{% if paper.imagecredit %}{{paper.imagecredit}}{% endif %}"> 
